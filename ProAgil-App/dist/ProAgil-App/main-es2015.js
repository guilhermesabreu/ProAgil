...
let EventosComponent = class EventosComponent {
    ...
    filtraEventos(filtraPor) {
        filtraPor = filtraPor.toLocaleLowerCase();
        return this.eventos.filter(evento => evento.tema.toLocaleLowerCase().indexOf(filtraPor) !== -1);
    }
    alternarImagem() {
...
module.exports = __webpack_require__(/*! C:\src\WS- Web\ESTUDO_FÉRIAS\DOTNETCORE\ProAgil-App\src\main.ts */"./src/main.ts");
